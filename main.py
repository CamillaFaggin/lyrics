...
def main():
    ...
    parser.add_argument("-- verbosity", help="n. lyrics are displayed.",
                        action="store_true")
...
#  define the input values
    ...
    if status == 404:
        ...
        if len(list_lyr) == 0:
            ...
            print("Verify that you haven't mispelled, or change your song.")
        else:
...
#  first 5 only
        ...
        def fun_sqlite():
            ...
            curs1 = conn1. cursor()
#  curs1.execute('''CREATE TABLE tablelyr1,
#  (artist_name, song_title, lyrics)''')
            curs1.execute("INSERT INTO tablelyr1 VALUES (?,?,?)",
                          (artist_name, song_title, list_lyr3))
